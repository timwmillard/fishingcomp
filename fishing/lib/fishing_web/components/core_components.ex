defmodule FishingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FishingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FishingWeb.Gettext, "errors", msg, opts)
    end
  end
